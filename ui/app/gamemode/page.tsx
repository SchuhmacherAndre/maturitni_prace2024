  ...
  return (
    ...
    <div className="overflow-x-hidden overflow-y-auto">
      ...
      <DrawerTrigger asChild>
        <Button variant="outline" className="h-64 w-64 text-2xl">Select Gamemode</Button>
      </DrawerTrigger>
      <DrawerContent>
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader>
            <DrawerTitle>Select your preferred gamemode</DrawerTitle>
            <DrawerDescription>Set up your ideal game here.</DrawerDescription>
          </DrawerHeader>
          <div className="p-4 pb-0">
            <div className="flex items-center justify-center space-x-2">
              ...
              <div className="flex justify-center items-center space-x-2  ">
                <Button variant={isButtonSelected(1) ? 'secondary' : 'outline'} onClick={() => handleButtonClick(1)}>
                  501
                </Button>
                <Button variant={isButtonSelected(2) ? 'secondary' : 'outline'} onClick={() => handleButtonClick(2)}>
                  301
                </Button>
                <Button variant={isButtonSelected(3) ? 'secondary' : 'outline'} onClick={() => handleButtonClick(3)}>
                  101
                </Button>
              </div>
              </div>
